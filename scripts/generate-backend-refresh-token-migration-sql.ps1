param(
    [string]$FromMigration = '20260604121000_AddCmsDraftSaveAuditMetadata',

    [string]$ToMigration = '20260611000000_AddUserRefreshTokens',
...
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    $suffix = if ($Idempotent) { 'idempotent' } else { 'from-20260604121000' }
    $OutputPath = Join-Path $sqlDir "20260611000000_AddUserRefreshTokens.$suffix.sql"
}
...
Write-Host "This script does not connect to production and does not read or print database secrets."
