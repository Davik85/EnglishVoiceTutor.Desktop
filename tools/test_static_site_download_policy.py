...
def main() -> int:
    ...
    assert_contains(download_html, 'data-download-lightbox-src="assets/images/download/quick-start.webp"', "quick start lightbox trigger")
    assert_contains(download_js, "createScreenshotLightbox", "download screenshot lightbox creation")
