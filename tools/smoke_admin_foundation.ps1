...
Assert-True -Condition ($adminCapabilities.Body.roles -contains "super_admin") -Message "BootstrapAdmin /api/admin/capabilities roles include super_admin"
Assert-True -Condition ($adminCapabilities.Body.permissions -contains $AdminSelfReadPermission) -Message "BootstrapAdmin /api/admin/capabilities permissions include admin.self.read"
Assert-True -Condition ($adminCapabilities.Body.permissions -contains $AdminCapabilitiesReadPermission) -Message "BootstrapAdmin /api/admin/capabilities permissions include admin.capabilities.read"
Assert-PropertyExists -Object $adminCapabilities.Body -PropertyName "capabilities" -Message "Admin capabilities response includes capabilities object"
