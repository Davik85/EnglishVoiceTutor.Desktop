...
Assert-JsonNumber -Body $first.Body -PropertyName "entitlementActivationChecked" -ExpectedValue 1 -Scenario "first signed webhook"
...
Assert-JsonFlag -Body $duplicate.Body -PropertyName "entitlementActivated" -ExpectedValue $false -Scenario "duplicate signed webhook"
...
Assert-JsonNumber -Body $duplicate.Body -PropertyName "entitlementActivationBlocked" -ExpectedValue 0 -Scenario "duplicate signed webhook"
