...
def main() -> None:
    ...
    assert_contains(welcome_code, "WelcomeHeroImage.Width = targetCardWidth", "welcome hero fills adaptive card width")
    assert_contains(welcome_code, "WelcomeHeroImage.Height = targetCardHeight", "welcome hero fills adaptive card height")
    ...
    assert_contains(welcome_code, "ApplyAdaptiveWelcomeLayout", "welcome adapts to available size")
