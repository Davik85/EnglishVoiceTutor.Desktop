...
- External tester handoff is still blocked until CMS/Admin server verification, update UI/system with installed-version checks, clean-machine smoke, and checklist completion are done.
