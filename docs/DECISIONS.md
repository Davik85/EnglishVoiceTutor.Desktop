...
- Realtime remains implemented/partially stabilized in the repository for future provider-switch testing, but it is not the default MVP Conversation Mode provider.
- Default MVP Conversation Mode should not open a Realtime WebSocket.
