...
- Deployed verification is on backend `0.1.35-backend.7`. Backend health is green, database health is green, build is green, Admin shell audit is green, and the EF model check reports no pending model changes.
