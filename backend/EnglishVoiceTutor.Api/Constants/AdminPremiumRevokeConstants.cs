...
public static class AdminPremiumRevokeConstants
{
    ...
    public const string EntitlementNotFoundError = "Premium entitlement was not found.";
    public const string EntitlementNotRevokableError = "Only active Premium access entitlements can be revoked.";
    ...
    public static class MetadataKeys
    {
        ...
        public const string AccessControlOnly = "accessControlOnly";
    }
}
