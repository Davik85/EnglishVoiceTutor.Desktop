...
public sealed record GooglePlayVerifiedPurchasePersistenceRequest(Guid UserId, string PurchaseToken, GooglePlayVerifiedPurchase VerifiedPurchase, string ProtectedPurchaseToken);
