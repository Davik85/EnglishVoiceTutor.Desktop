...
public static class AdminEndpointPermissionCatalog
{
    ...
    [
        ...
        new("admin.account_anonymization.execute", "FUTURE", null, AdminPermissionConstants.AccountAnonymizationExecute, "Future destructive account-anonymization execution seam; no execute endpoint exists in the read-only foundation."),
