...
public static class AdminEndpointPermissionCatalog
{
    ...
    [
        ...
        new("admin.account_anonymization.preflight", "POST", ApiConstants.AdminFeedbackReportAccountAnonymizationPreflightRoute, AdminPermissionConstants.AccountAnonymizationPreflightRead, "Create or refresh a read-only account-anonymization preflight."),
        new("admin.account_anonymization.status.read", "GET", ApiConstants.AdminFeedbackReportAccountAnonymizationRoute, AdminPermissionConstants.AccountAnonymizationPreflightRead, "Read a persisted account-anonymization preflight without recomputation."),
        new("admin.account_anonymization.execute", "POST", ApiConstants.AdminFeedbackReportAccountAnonymizationExecuteRoute, AdminPermissionConstants.AccountAnonymizationExecute, "Execute a fresh approved account-anonymization preflight through the local transaction-scoped operation."),
        ...
        new("admin.system.ai_models.draft_save", "POST", ApiConstants.AdminAiModelSettingsDraftRoute, AdminPermissionConstants.SystemAiModelSettingsManage, "Save Super Admin AI model CMS draft settings."),
        new("admin.system.ai_models.validate", "POST", ApiConstants.AdminAiModelSettingsValidateRoute, AdminPermissionConstants.SystemAiModelSettingsManage, "Validate Super Admin AI model CMS draft settings."),
        new("admin.system.ai_models.provider_test", "POST", ApiConstants.AdminAiModelSettingsProviderTestRoute, AdminPermissionConstants.SystemAiModelSettingsManage, "Test Super Admin AI model provider access for draft settings."),
        new("admin.system.ai_models.publish", "POST", ApiConstants.AdminAiModelSettingsPublishRoute, AdminPermissionConstants.SystemAiModelSettingsManage, "Publish Super Admin AI model CMS settings."),
