    ...
    public partial class AddAdminRoleAssignmentPersistence : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admin_role_assignment_events_ActionType",
                table: "admin_role_assignment_events",
                column: "ActionType");

            migrationBuilder.CreateIndex(
                name: "IX_admin_role_assignment_events_ActorAdminUserId",
                table: "admin_role_assignment_events",
                column: "ActorAdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_admin_role_assignment_events_OccurredAtUtc",
                table: "admin_role_assignment_events",
                column: "OccurredAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_admin_role_assignment_events_Result",
                table: "admin_role_assignment_events",
                column: "Result");

            migrationBuilder.CreateIndex(
                name: "IX_admin_role_assignment_events_RoleId",
                table: "admin_role_assignment_events",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_admin_role_assignment_events_TargetAdminUserId",
                table: "admin_role_assignment_events",
                column: "TargetAdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_admin_user_roles_AdminUserId",
                table: "admin_user_roles",
                column: "AdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_admin_user_roles_AdminUserId_RoleId",
                table: "admin_user_roles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admin_user_roles_AssignedByAdminUserId",
                table: "admin_user_roles",
                column: "AssignedByAdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_admin_user_roles_RevokedAtUtc",
                table: "admin_user_roles",
                column: "RevokedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_admin_user_roles_RevokedByAdminUserId",
                table: "admin_user_roles",
                column: "RevokedByAdminUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admin_users_CreatedByAdminUserId",
                table: "admin_users",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admin_users_Status",
                table: "admin_users",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_admin_users_UserId",
                table: "admin_users",
                column: "UserId");
        }
