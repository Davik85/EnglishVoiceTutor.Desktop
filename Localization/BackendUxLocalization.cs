...
public static class BackendUxLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, BackendUxLocalizedText> TextByLanguageId = new Dictionary<string, BackendUxLocalizedText>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["fr"] = new(
            ...
            "Il y a trop de demandes en ce moment. Patientez un instant puis réessayez.",
        ...
        ["de"] = new(
            ...
            "Im Moment gibt es zu viele Anfragen. Warte einen Moment und versuche es erneut.",
        ...
        ["it"] = new(
            ...
            "Ci sono troppe richieste in questo momento. Attendi un momento e riprova.",
        ...
        ["pt"] = new(
            ...
            "Há muitas solicitações neste momento. Aguarde um momento e tente novamente.",
        ...
        ["ru"] = new(
            ...
            "Сейчас слишком много запросов. Подождите немного и попробуйте снова.",
        ...
        ["ar"] = new(
            ...
            "هناك عدد كبير جدًا من الطلبات الآن. انتظر لحظة وحاول مرة أخرى.",
        ...
        ["ja"] = new(
            ...
            "現在リクエストが多すぎます。少し待ってから、もう一度お試しください。",
        ...
        ["ko"] = new(
            ...
            "현재 요청이 너무 많습니다. 잠시 기다린 후 다시 시도하세요.",
        ...
        ["sr"] = new(
            ...
            "Trenutno ima previše zahteva. Sačekajte trenutak i pokušajte ponovo.",
        ...
        ["hr"] = new(
            ...
            "Trenutno ima previše zahtjeva. Pričekajte trenutak i pokušajte ponovno.",
        ...
        ["bg"] = new(
            ...
            "В момента има твърде много заявки. Изчакайте малко и опитайте отново.",
