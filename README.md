...
Current release-readiness status: `0.1.26-tester.1` is the current validated private tester/direct Windows release. Clean-machine smoke, small-group external tester handoff, feedback collection, code signing, production billing, and broader public-readiness work remain follow-up items. See `docs/CURRENT_STATE.md`, `docs/NEXT_STEPS.md`, and `docs/TESTER_RELEASE.md`.
