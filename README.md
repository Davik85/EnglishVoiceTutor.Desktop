...
Paddle webhook ingestion smoke requires a running backend with `PaddleWebhook__Enabled=true` and `PaddleWebhook__SecretKey=test_webhook_secret`; it also verifies immediate billing event normalization and reconciliation decision response fields:
