...
public sealed class BackendLessonHistoryDetailResponse
{
    ...
    public BackendLessonHistorySummaryResponse? Summary { get; set; }

    public IReadOnlyList<BackendLessonHistoryMessageResponse> Messages { get; set; } = [];
}
